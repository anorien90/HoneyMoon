...
const MARKER_STYLES = {
  first: { stroke: '#0f172a', fill: 'var(--accent)', radius: 10 },
  last: { stroke: '#0f172a', fill: 'var(--accent)', radius: 10 },
  middle: { stroke: '#7a2e00', fill: 'var(--accent-2)', radius: 7 }
};
