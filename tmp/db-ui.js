...
// Ensured all search results update the map and selected node consistently.
// Added caching for search results and improved accessibility.
...
export async function plotAnalysisHops(session) {
  ...
  // Ensure pinned nodes work: add pinned cards for each hop node
